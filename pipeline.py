...
def main():
    df = pd.read_csv("../../PycharmProjects/fetal_health_classification/data/fetal_health.csv")
    ...
    joblib.dump(lr, "../../PycharmProjects/fetal_health_classification/lr_model.pkl")
    #return voting_clf
